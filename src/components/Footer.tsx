    ...
    <footer className="bg-black">
      ...
      >
        <a href="/" className="flex gap-3 items-center">
          ...
          <HeadingH5 level={5} weight="bold" className="text-white">
            Personal
          </HeadingH5>
        </a>

        <div className="flex flex-col gap-3 items-center lg:items-end mt-4 lg:mt-0">
          <HeadingH6 weight="semibold" className="text-white">
            © {displayYear} Personal Portfolio
          </HeadingH6>
          <HeadingH6 weight="semibold" className="text-white">
            Made by ~SP
          </HeadingH6>
